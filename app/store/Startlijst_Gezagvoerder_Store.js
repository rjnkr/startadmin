/*
 * File: app/store/Startlijst_Gezagvoerder_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.Startlijst_Gezagvoerder_Store', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.LedenLijst_Model',
        'Ext.data.proxy.Ajax',
