/*
 * File: app/store/Startlijst_Vlieger_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.Startlijst_Vlieger_Store', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            proxy: {
                type: 'ajax',
                simpleSortMode: true,
                url: 'php/main.php?Action=Leden.LedenlijstKortJSON',
                reader: {
                    type: 'json',
                    idProperty: 'ID',
                    root: 'results'
