/*
 * File: app/store/ControleDagOverzicht_GridStore.js
 *
...
Ext.define('GeZC_StartAdministratie.store.ControleDagOverzicht_GridStore', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.ControleDagOverzicht_Model',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'GeZC_StartAdministratie.model.ControleDagOverzicht_Model',
