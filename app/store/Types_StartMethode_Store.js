/*
 * File: app/store/Types_StartMethode_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.Types_StartMethode_Store', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            storeId: 'Types.StartMethode.Store',
            proxy: {
                type: 'ajax',
                url: 'php/main.php?Action=Types.GetObjectsJSON&_:TYPEGROUP_ID=5',
                reader: {
                    type: 'json',
                    idProperty: 'ID'
                },
