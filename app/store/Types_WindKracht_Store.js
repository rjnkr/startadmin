/*
 * File: app/store/Types_WindKracht_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.Types_WindKracht_Store', {
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            ...
            proxy: {
                type: 'ajax',
                url: 'php/main.php?Action=Types.GetObjectsJSON&_:TYPEGROUP_ID=3',
                reader: {
                    type: 'json',
                    idProperty: 'ID'
                },
