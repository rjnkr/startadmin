/*
 * File: app/store/Export_GridStore.js
 *
...
Ext.define('GeZC_StartAdministratie.store.Export_GridStore', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.Export_Model',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            LaatsteAanpassing: '-1',
            autoSync: true,
            model: 'GeZC_StartAdministratie.model.Export_Model',
            storeId: 'Export_GridStore',
            remoteSort: true,
            proxy: {
                type: 'ajax',
                simpleSortMode: true,
                url: 'php/main.php?Action=Startlijst.ExportJSON',
                reader: {
                    type: 'json',
                    idProperty: 'ID',
                    root: 'results'
