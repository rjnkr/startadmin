/*
 * File: app/store/StartLijstVoorFlarm_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.StartLijstVoorFlarm_Store', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.StartLijstVoorFlarm_Model',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            autoSync: true,
            model: 'GeZC_StartAdministratie.model.StartLijstVoorFlarm_Model',
            storeId: 'StartLijstVoorFlarm_Store',
            remoteSort: true,
            proxy: {
                type: 'ajax',
                simpleSortMode: true,
                url: 'php/main.php?Action=Startlijst.StartLijstVoorFlarmJSON',
                reader: {
                    type: 'json',
                    idProperty: 'ID',
                    root: 'results'
