/*
 * File: app/store/ControleStartlijstTijdelijk_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.ControleStartlijstTijdelijk_Store', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.ControleStartlijstTijdelijkeLeden_Model',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'GeZC_StartAdministratie.model.ControleStartlijstTijdelijkeLeden_Model',
            storeId: 'ControleStartlijstTijdelijk_Store',
            remoteSort: true,
            proxy: {
                type: 'ajax',
                simpleSortMode: true,
                url: 'php/main.php?Action=Controle.StartlijstTijdelijkeLedenJSON',
                reader: {
                    type: 'json',
                    idProperty: 'ID',
                    root: 'results'
