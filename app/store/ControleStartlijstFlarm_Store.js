/*
 * File: app/store/ControleStartlijstFlarm_Store.js
 *
...
Ext.define('GeZC_StartAdministratie.store.ControleStartlijstFlarm_Store', {
    extend: 'Ext.data.Store',

    requires: [
        'GeZC_StartAdministratie.model.ControleStartlijstFlarm_Model',
        'Ext.data.proxy.Ajax',
    ...
    constructor: function(cfg) {
        ...
        me.callParent([Ext.apply({
            model: 'GeZC_StartAdministratie.model.ControleStartlijstFlarm_Model',
